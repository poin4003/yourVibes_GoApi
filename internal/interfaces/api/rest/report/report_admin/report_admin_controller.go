...
func NewAdminReportController() *cAdminReport {
	return &cAdminReport{}
}
...
func (c *cAdminReport) GetReportDetail(ctx *gin.Context) {
	...
	result, err := services.Report().GetDetailReport(ctx, getOneReportQuery)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cAdminReport) GetManyReports(ctx *gin.Context) {
	...
	result, err := services.Report().GetManyReport(ctx, getManyReportQuery)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cAdminReport) HandleReport(ctx *gin.Context) {
	...
	err = services.Report().HandleReport(ctx, handleUserReportCommand)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cAdminReport) DeleteReport(ctx *gin.Context) {
	...
	err = services.Report().DeleteReport(ctx, deleteReportCommand)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cAdminReport) Activate(ctx *gin.Context) {
	...
	err = services.Report().Activate(ctx, activateCommand)
	if err != nil {
		ctx.Error(err)
		return
	}
