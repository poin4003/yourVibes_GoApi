...
type cSuperAdmin struct {
	superAdminService services.ISuperAdmin
...
func (c *cSuperAdmin) CreateAdmin(ctx *gin.Context) {
	...
	result, err := c.superAdminService.CreateAdmin(ctx, createAdminCommand)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cSuperAdmin) UpdateAdmin(ctx *gin.Context) {
	...
	result, err := c.superAdminService.UpdateAdmin(ctx, updateAdminForSuperAdminCommand)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cSuperAdmin) GetAdminById(ctx *gin.Context) {
	...
	result, err := c.superAdminService.GetOneAdmin(ctx, getOneAdminQuery)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cSuperAdmin) GetManyAdmins(ctx *gin.Context) {
	...
	result, err := c.superAdminService.GetManyAdmin(ctx, getManyAdminQuery)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func (c *cSuperAdmin) ForgotAdminPassword(ctx *gin.Context) {
	...
	err = c.adminAuthService.ForgotAdminPassword(ctx, forgotAdminPasswordCommand)
	if err != nil {
		ctx.Error(pkgResponse.NewServerFailedError(err.Error()))
		return
	}
