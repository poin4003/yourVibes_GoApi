...
import (
	...
	mapper2 "github.com/poin4003/yourVibes_GoApi/internal/interfaces/rest/comment/comment_user/dto/mapper"
...
func (p *cCommentLike) LikeComment(ctx *gin.Context) {
	...
	likeUserCommentModel := mapper2.MapToLikeUserCommentFromCommentIdAndUserId(commentId, userUUID)
