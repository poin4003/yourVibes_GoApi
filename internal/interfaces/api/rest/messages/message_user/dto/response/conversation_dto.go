...
type ConversationWithActiveStatus struct {
	ID             uuid.UUID  `json:"id"`
	Name           string     `json:"name"`
	Image          string     `json:"image"`
	Avatar         string     `json:"avatar,omitempty"`
...
func ToConversationWithActiveStatusDto(
	conversationResult *common.ConversationWithActiveStatusResult,
) *ConversationWithActiveStatus {
	if conversationResult == nil {
		return nil
	}
	return &ConversationWithActiveStatus{
		ID:             conversationResult.ID,
		Name:           conversationResult.Name,
		Image:          conversationResult.Image,
		UserID:         conversationResult.UserID,
		...
		LastMess:       conversationResult.LastMess,
		LastMessStatus: conversationResult.LastMessStatus,
		ActiveStatus:   conversationResult.ActiveStatus,
	}
}
