...
func (s *sNotificationMQ) HandleBulkNotification(ctx context.Context, command notificationCommand.NotificationCommand) error {
	...
	if global.SocketHub != nil {
		for _, notification := range notifications {
			...
			if err := global.SocketHub.SendNotification(notification.UserId.String(), socketMsg); err != nil {
