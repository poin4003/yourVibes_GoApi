...
func InitServiceInterface(db *gorm.DB) {
	...
	userNewFeedService := post_service_impl.NewUserNewFeedImplement(userRepo, postRepo, postLikeRepo, newFeedRepo)
	...
	user_service.InitUserNewFeed(userNewFeedService)
